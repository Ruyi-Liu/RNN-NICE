...
for (i in 1:1000) {
  seed_num <- 20250000 + i
  file_name <- paste0("simulated_data_2_seed_", seed_num, "_sdZ_01_sdEps_3.csv")
  file_path <- file.path("/Users/ruyi/Desktop/452 Final Project/simulation_data/parallel_linear_sd_Z_01_sd_eps_3", file_name)
